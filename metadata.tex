...
% Title
\newcommand{\pubtitle}{Anoma P2P Architecture}

\newcommand{\pubauthA}{Naqib Zarin }
\newcommand{\pubaffilA}{a}
% \newcommand{\orcidA}{0000-0001-5477-1503}
\newcommand{\authemailA}{naqib@heliax.dev}
% \newcommand{\eqcontribA}{}

\newcommand{\pubauthB}{TG}
\newcommand{\pubaffilB}{a}
% \newcommand{\orcidB}{0000-0001-0000-0000}
\newcommand{\authemailB}{tg@heliax.dev}
